...
var MigrationTableColumns = struct {
	...
	ID:        "migrations.id",
	CreatedAt: "migrations.created_at",
...
func FindMigration(exec boil.Executor, iD uint, selectCols ...string) (*Migration, error) {
	...
	if err = migrationObj.doAfterSelectHooks(exec); err != nil {
...
func (o *Migration) Exists(exec boil.Executor) (bool, error) {
	return MigrationExists(exec, o.ID)
}
