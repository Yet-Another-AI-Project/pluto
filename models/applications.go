...
var ApplicationTableColumns = struct {
	...
	Webhook:             "applications.webhook",
	DefaultRole:         "applications.default_role",
	I18nApplicationName: "applications.i18n_application_name",
	GoogleLogin:         "applications.google_login",
	WechatLogin:         "applications.wechat_login",
	AppleLogin:          "applications.apple_login",
}
...
type applicationR struct {
	AppBindings BindingSlice `boil:"AppBindings" json:"AppBindings" toml:"AppBindings" yaml:"AppBindings"`
	AppUsers    UserSlice    `boil:"AppUsers" json:"AppUsers" toml:"AppUsers" yaml:"AppUsers"`
}
...
func (r *applicationR) GetAppBindings() BindingSlice {
	if r == nil {
		return nil
	}
	return r.AppBindings
}

func (r *applicationR) GetAppUsers() UserSlice {
	if r == nil {
		return nil
	}
	return r.AppUsers
...
func (applicationL) LoadAppBindings(e boil.Executor, singular bool, maybeApplication interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`bindings`),
		qm.WhereIn(`bindings.app_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (applicationL) LoadAppUsers(e boil.Executor, singular bool, maybeApplication interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`users`),
		qm.WhereIn(`users.app_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindApplication(exec boil.Executor, iD uint, selectCols ...string) (*Application, error) {
	...
	if err = applicationObj.doAfterSelectHooks(exec); err != nil {
...
func (o *Application) Exists(exec boil.Executor) (bool, error) {
	return ApplicationExists(exec, o.ID)
}
