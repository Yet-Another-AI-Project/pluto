...
var RbacUserApplicationRoleTableColumns = struct {
	ID        string
	CreatedAt string
	UpdatedAt string
	DeletedAt string
	...
	ID:        "rbac_user_application_roles.id",
	CreatedAt: "rbac_user_application_roles.created_at",
	UpdatedAt: "rbac_user_application_roles.updated_at",
	DeletedAt: "rbac_user_application_roles.deleted_at",
	UserID:    "rbac_user_application_roles.user_id",
	AppID:     "rbac_user_application_roles.app_id",
	RoleID:    "rbac_user_application_roles.role_id",
}
...
var (
	...
	rbacUserApplicationRoleGeneratedColumns      = []string{}
)

type (
	// RbacUserApplicationRoleSlice is an alias for a slice of pointers to RbacUserApplicationRole.
	// This should almost always be used instead of []RbacUserApplicationRole.
...
func RbacUserApplicationRoles(mods ...qm.QueryMod) rbacUserApplicationRoleQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"`rbac_user_application_roles`.*"})
	}

	return rbacUserApplicationRoleQuery{q}
}
...
func FindRbacUserApplicationRole(exec boil.Executor, iD uint, selectCols ...string) (*RbacUserApplicationRole, error) {
	...
	if err = rbacUserApplicationRoleObj.doAfterSelectHooks(exec); err != nil {
		return rbacUserApplicationRoleObj, err
	}
...
// Exists checks if the RbacUserApplicationRole row exists.
func (o *RbacUserApplicationRole) Exists(exec boil.Executor) (bool, error) {
	return RbacUserApplicationRoleExists(exec, o.ID)
}
